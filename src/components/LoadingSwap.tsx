...
export function LoadingSwap({ isLoading, children, className }: { isLoading: boolean, children: React.ReactNode, className?: string }) {
    return (<div className="grid items-center justify-items-center">
