...
CREATE TYPE "public"."job_listings_location_requirement" AS ENUM('remote', 'in-office', 'hybrid');--> statement-breakpoint
CREATE TYPE "public"."job_listings_wage_interval" AS ENUM('hourly', 'daily', 'weekly', 'monthly', 'yearly');--> statement-breakpoint
CREATE TYPE "public"."job_listing_applications_stage" AS ENUM('applied', 'denied', 'interested', 'hired', 'interviewed');--> statement-breakpoint
CREATE TABLE "users" (
