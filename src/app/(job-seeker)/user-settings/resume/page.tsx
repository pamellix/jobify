...
async function ResumeDetails() {
    ...
    return <CardFooter>
        <Button asChild>
            <Link href={userResume.resumeFileUrl} target="_blank" rel="noopener noreferrer">View Resume</Link>
        </Button>
    </CardFooter>
}
...
async function AISummaryCard() {
    ...
    return <Card>
        <CardHeader className="border-b">
            ...
            <CardDescription>This is AI-generated summary of your resume. This is used by employers to quickly understand your qualifications and experience.</CardDescription>
        </CardHeader>
        <CardContent>
