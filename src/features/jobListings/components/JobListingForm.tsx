...
import { experienceLevel, JobListingTable, jobListingType, locationRequirements, wageIntervals } from "@/drizzle/schema";
                    ...
                    <FormField
                        ...
                        control={form.control} render={({ field }) => (
                            <FormItem>
                                ...
                                <Select value={field.value ?? ""} onValueChange={val => val === NONE_SELECT_VALUE ? field.onChange(null) : field.onChange(val)}>
                                    <FormControl>
