...
import { applicationStage, ApplicationStage, JobListingTable, UserResumeTable } from "@/drizzle/schema";
...
export async function updateJobListingApplicationStage({
    ...
    if (
        ...
        error: true,
        message: "You don't have permission to update this application stage"
    }
...
export async function updateJobListingApplicationRating({
    ...
    if (
        ...
        error: true,
        message: "You don't have permission to update this application rating"
    }
